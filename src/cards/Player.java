...
public class Player {
	...
	public void hand(List<Card> deck, int playerHand, int dealerHand, Card dealerCard2) {
		...
		if ((!choice.equals("H")) && (!choice.equals("h")) && (!choice.equals("S")) && (!choice.equals("s"))) {
			System.err.print("That is an invalid entry\n");
			hand(deck, playerHand, dealerHand, dealerCard2);
		}
